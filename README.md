...
- I wrote this code while i was stuck in traffic but i gladly managed to optimise it further.
- Update : I've optimised the source code and i'm hoping for a code review
...
2. Implement logic for user defined total floors (Skyscraper logic). -> this will be done only if needed and will further be implemented in the client side.
